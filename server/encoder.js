...
const isInvalidString = (str) =>
  str
    ? str.indexOf(threadPrefix) !== -1 || str.indexOf(messagePrefix) !== -1
    : false;
...
console.log(encode("1329359200606888311"));
